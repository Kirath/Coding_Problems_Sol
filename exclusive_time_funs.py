...
# popped off the stack. The function whose ID is at the top of the stack
...
# "{function_id}:{"start" | "end"}:{timestamp}". For example, "0:start:3" means a function call w
# ith function ID 0 started at the beginning of timestamp 3, and "1:end:2" means a function call
...
# So function 0 spends 2 + 1 = 3 units of total time executing, and function 1 spends 4 units
